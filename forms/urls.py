...
urlpatterns = [
	...
	path("physical_examination_diabetess/", Physical_examination_diabetes_ListView.as_view(), name="physical_examination_diabetes_list_url"),
	path("physical_examination_diabetes/create/", Physical_examination_diabetes_CreateView.as_view(), name="physical_examination_diabetes_create_url"),
	path("physical_examination_diabetes/<str:slug>/", Physical_examination_diabetes_DetailView.as_view(), name="physical_examination_diabetes_detail_url"),
	path("physical_examination_diabetes/<str:slug>/update/", Physical_examination_diabetes_UpdateView.as_view(), name="physical_examination_diabetes_update_url"),
	path("physical_examination_diabetes/<str:slug>/delete/", Physical_examination_diabetes_DeleteView.as_view(), name="physical_examination_diabetes_delete_url"),
]