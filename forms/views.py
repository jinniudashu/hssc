...
class Dorsal_artery_pulsation_examination_ListView(ListView):
	model = Dorsal_artery_pulsation_examination
	context_object_name = "dorsal_artery_pulsation_examinations"
	template_name = "dorsal_artery_pulsation_examination_list.html"


class Dorsal_artery_pulsation_examination_CreateView(SuccessMessageMixin, CreateView):
	template_name = "dorsal_artery_pulsation_examination_edit.html"
	form_class = Dorsal_artery_pulsation_examination_ModelForm
	success_message = "保存成功！"


class Dorsal_artery_pulsation_examination_DetailView(DetailView):
	model = Dorsal_artery_pulsation_examination
	context_object_name = "dorsal_artery_pulsation_examination"
	template_name = "dorsal_artery_pulsation_examination_detail.html"

	def get_object(self):
		dorsal_artery_pulsation_examination = super(Dorsal_artery_pulsation_examination_DetailView, self).get_object()
		form = Dorsal_artery_pulsation_examination_ModelForm(instance=dorsal_artery_pulsation_examination)
		return form


class Dorsal_artery_pulsation_examination_UpdateView(SuccessMessageMixin, UpdateView):
	template_name = "dorsal_artery_pulsation_examination_edit.html"
	form_class = Dorsal_artery_pulsation_examination_ModelForm
	success_url = "/"
	success_message = "保存成功！"
	...
	def get_queryset(self):
		return Dorsal_artery_pulsation_examination.objects.all()


class Dorsal_artery_pulsation_examination_DeleteView(DeleteObjectMixin, View):
	model = Dorsal_artery_pulsation_examination
	template = "dorsal_artery_pulsation_examination_delete.html"
	redirect_url = "dorsal_artery_pulsation_examination_list_url"
	raise_exception = True


class Routine_blood_test_ListView(ListView):
	model = Routine_blood_test
	context_object_name = "routine_blood_tests"
	template_name = "routine_blood_test_list.html"


class Routine_blood_test_CreateView(SuccessMessageMixin, CreateView):
	template_name = "routine_blood_test_edit.html"
	form_class = Routine_blood_test_ModelForm
	success_message = "保存成功！"


class Routine_blood_test_DetailView(DetailView):
	model = Routine_blood_test
	context_object_name = "routine_blood_test"
	template_name = "routine_blood_test_detail.html"

	def get_object(self):
		routine_blood_test = super(Routine_blood_test_DetailView, self).get_object()
		form = Routine_blood_test_ModelForm(instance=routine_blood_test)
		return form


class Routine_blood_test_UpdateView(SuccessMessageMixin, UpdateView):
	template_name = "routine_blood_test_edit.html"
	form_class = Routine_blood_test_ModelForm
	success_url = "/"
	success_message = "保存成功！"
	...
	def get_queryset(self):
		return Routine_blood_test.objects.all()


class Routine_blood_test_DeleteView(DeleteObjectMixin, View):
	model = Routine_blood_test
	template = "routine_blood_test_delete.html"
	redirect_url = "routine_blood_test_list_url"
	raise_exception = True


class Fundus_examination_ListView(ListView):
	model = Fundus_examination
	context_object_name = "fundus_examinations"
	template_name = "fundus_examination_list.html"


class Fundus_examination_CreateView(SuccessMessageMixin, CreateView):
	template_name = "fundus_examination_edit.html"
	form_class = Fundus_examination_ModelForm
	success_message = "保存成功！"


class Fundus_examination_DetailView(DetailView):
	model = Fundus_examination
	context_object_name = "fundus_examination"
	template_name = "fundus_examination_detail.html"

	def get_object(self):
		fundus_examination = super(Fundus_examination_DetailView, self).get_object()
		form = Fundus_examination_ModelForm(instance=fundus_examination)
		return form


class Fundus_examination_UpdateView(SuccessMessageMixin, UpdateView):
	template_name = "fundus_examination_edit.html"
	form_class = Fundus_examination_ModelForm
	success_url = "/"
	success_message = "保存成功！"
	...
	def get_queryset(self):
		return Fundus_examination.objects.all()


class Fundus_examination_DeleteView(DeleteObjectMixin, View):
	model = Fundus_examination
	template = "fundus_examination_delete.html"
	redirect_url = "fundus_examination_list_url"
	raise_exception = True


class Lower_extremity_edema_examination_ListView(ListView):
	model = Lower_extremity_edema_examination
	context_object_name = "lower_extremity_edema_examinations"
	template_name = "lower_extremity_edema_examination_list.html"


class Lower_extremity_edema_examination_CreateView(SuccessMessageMixin, CreateView):
	template_name = "lower_extremity_edema_examination_edit.html"
	form_class = Lower_extremity_edema_examination_ModelForm
	success_message = "保存成功！"


class Lower_extremity_edema_examination_DetailView(DetailView):
	model = Lower_extremity_edema_examination
	context_object_name = "lower_extremity_edema_examination"
	template_name = "lower_extremity_edema_examination_detail.html"

	def get_object(self):
		lower_extremity_edema_examination = super(Lower_extremity_edema_examination_DetailView, self).get_object()
		form = Lower_extremity_edema_examination_ModelForm(instance=lower_extremity_edema_examination)
		return form


class Lower_extremity_edema_examination_UpdateView(SuccessMessageMixin, UpdateView):
	template_name = "lower_extremity_edema_examination_edit.html"
	form_class = Lower_extremity_edema_examination_ModelForm
	success_url = "/"
	success_message = "保存成功！"
	...
	def get_queryset(self):
		return Lower_extremity_edema_examination.objects.all()


class Lower_extremity_edema_examination_DeleteView(DeleteObjectMixin, View):
	model = Lower_extremity_edema_examination
	template = "lower_extremity_edema_examination_delete.html"
	redirect_url = "lower_extremity_edema_examination_list_url"
	raise_exception = True