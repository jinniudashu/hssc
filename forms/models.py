...
class Ren_shen_xian_li_pei_shen_qing_shu(HsscFormModel):
    ...
    relatedfield_gender = models.ForeignKey(Gender, related_name='gender_for_relatedfield_gender_ren_shen_xian_li_pei_shen_qing_shu', on_delete=models.CASCADE, null=True, blank=False, verbose_name='性别')
...
class Men_zhen_fu_wu_ji_lu_2(HsscFormModel):
    boolfield_fei_yong_he_ji = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=False, verbose_name='费用合计')
    relatedfield_symptom_list = models.ManyToManyField(Icpc3_symptoms_and_problems, related_name='icpc3_symptoms_and_problems_for_relatedfield_symptom_list_men_zhen_fu_wu_ji_lu_2', blank=True, verbose_name='症状')
    ...
    boolfield_qi_ta_fu_wu_xiang_mu = models.ManyToManyField(Icpc8_other_health_interventions, related_name='icpc8_other_health_interventions_for_boolfield_qi_ta_fu_wu_xiang_mu_men_zhen_fu_wu_ji_lu_2', blank=True, verbose_name='其他健康干预服务')
    boolfield_men_zhen_bing_li_fu_jian = models.ImageField(upload_to='uploads/', null=True, blank=False, verbose_name='门诊病历附件')
    class Meta:
        verbose_name = '门诊接续服务记录'
        verbose_name_plural = verbose_name
