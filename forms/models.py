...
class A6207(HsscFormModel):
    boolfield_yao_pin_ming = models.ManyToManyField(Medicine, related_name='medicine_for_boolfield_yao_pin_ming_A6207', blank=True, verbose_name='药品名')
    class Meta:
        verbose_name = '过敏史'
...
class T4501(HsscFormModel):
    boolfield_ying_yang_gan_yu = models.ManyToManyField(Icpc8_other_health_interventions, related_name='icpc8_other_health_interventions_for_boolfield_ying_yang_gan_yu_T4501', blank=True, verbose_name='营养干预')
    class Meta:
        verbose_name = '营养干预'
        verbose_name_plural = verbose_name
...
class A6215(HsscFormModel):
    ...
    boolfield_dui_mu_qian_sheng_huo_he_gong_zuo_man_yi_ma = models.ForeignKey(Satisfaction, related_name='satisfaction_for_boolfield_dui_mu_qian_sheng_huo_he_gong_zuo_man_yi_ma_A6215', on_delete=models.CASCADE, null=True, blank=True, verbose_name='对目前生活和工作满意吗')
    boolfield_dui_zi_ji_de_shi_ying_neng_li_man_yi_ma = models.ForeignKey(Satisfaction, related_name='satisfaction_for_boolfield_dui_zi_ji_de_shi_ying_neng_li_man_yi_ma_A6215', on_delete=models.CASCADE, null=True, blank=True, verbose_name='对自己的适应能力满意吗')
    class Meta:
...
class Z6201(HsscFormModel):
    ...
    boolfield_mi_ma_she_zhi = models.CharField(max_length=255, null=True, blank=True, verbose_name='密码设置')
    boolfield_que_ren_mi_ma = models.CharField(max_length=255, null=True, blank=True, verbose_name='确认密码')
    boolfield_xing_ming = models.CharField(max_length=255, null=True, blank=True, verbose_name='姓名')
    boolfield_nian_ling = models.CharField(max_length=255, null=True, blank=True, verbose_name='年龄')
...
class A3110(HsscFormModel):
    boolfield_zuo_er_ting_li = models.ForeignKey(Hearing, related_name='hearing_for_boolfield_zuo_er_ting_li_A3110', on_delete=models.CASCADE, null=True, blank=True, verbose_name='左耳听力')
    boolfield_you_er_ting_li = models.ForeignKey(Hearing, related_name='hearing_for_boolfield_you_er_ting_li_A3110', on_delete=models.CASCADE, null=True, blank=True, verbose_name='右耳听力')
    class Meta:
        verbose_name = '听力检查'
        verbose_name_plural = verbose_name
...
class A6216(HsscFormModel):
    boolfield_nin_dui_ju_zhu_huan_jing_man_yi_ma = models.ForeignKey(Satisfaction, related_name='satisfaction_for_boolfield_nin_dui_ju_zhu_huan_jing_man_yi_ma_A6216', on_delete=models.CASCADE, null=True, blank=True, verbose_name='您对居住环境满意吗')
    boolfield_nin_suo_zai_de_she_qu_jiao_tong_fang_bian_ma = models.ForeignKey(Convenience, related_name='convenience_for_boolfield_nin_suo_zai_de_she_qu_jiao_tong_fang_bian_ma_A6216', on_delete=models.CASCADE, null=True, blank=True, verbose_name='您所在的社区交通方便吗')
    class Meta:
        verbose_name = '社会环境评估'
        verbose_name_plural = verbose_name
...
class Fu_wu(HsscFormModel):
    ...
    boolfield_ze_ren_ren = models.ForeignKey(Staff, related_name='staff_for_boolfield_ze_ren_ren_fu_wu', on_delete=models.CASCADE, null=True, blank=True, verbose_name='责任人')
...
class Z6205(HsscFormModel):
    ...
    boolfield_nian_ling = models.CharField(max_length=255, null=True, blank=True, verbose_name='年龄')
    boolfield_chu_sheng_ri_qi = models.DateField(null=True, blank=True, verbose_name='出生日期')
    boolfield_suo_shu_ji_gou = models.ForeignKey(Institution, related_name='institution_for_boolfield_suo_shu_ji_gou_Z6205', on_delete=models.CASCADE, null=True, blank=True, verbose_name='所属机构')
    boolfield_fu_wu_jue_se = models.ManyToManyField(Fu_wu_jue_se, related_name='fu_wu_jue_se_for_boolfield_fu_wu_jue_se_Z6205', blank=True, verbose_name='服务角色')
    class Meta:
        verbose_name = '医生注册'
        verbose_name_plural = verbose_name
...
class A3108(HsscFormModel):
    boolfield_kou_chun = models.ForeignKey(Lips, related_name='lips_for_boolfield_kou_chun_A3108', on_delete=models.CASCADE, null=True, blank=True, verbose_name='口唇')
    boolfield_chi_lie = models.ForeignKey(Dentition, related_name='dentition_for_boolfield_chi_lie_A3108', on_delete=models.CASCADE, null=True, blank=True, verbose_name='齿列')
    boolfield_yan_bu = models.ForeignKey(Pharynx, related_name='pharynx_for_boolfield_yan_bu_A3108', on_delete=models.CASCADE, null=True, blank=True, verbose_name='咽部')
    class Meta:
        verbose_name = '口腔检查'
        verbose_name_plural = verbose_name
...
class T4502(HsscFormModel):
    boolfield_yun_dong_gan_yu = models.ManyToManyField(Icpc8_other_health_interventions, related_name='icpc8_other_health_interventions_for_boolfield_yun_dong_gan_yu_T4502', blank=True, verbose_name='运动干预')
    class Meta:
        verbose_name = '运动干预'
        verbose_name_plural = verbose_name
...
class Yong_yao_diao_cha_biao(HsscFormModel):
    boolfield_yao_pin_ming = models.ManyToManyField(Medicine, related_name='medicine_for_boolfield_yao_pin_ming_yong_yao_diao_cha_biao', blank=True, verbose_name='药品名')
    class Meta:
        verbose_name = '用药调查表'
        verbose_name_plural = verbose_name
...
class T3003(HsscFormModel):
    boolfield_zuo_jiao = models.ForeignKey(Dorsal_artery_pulsation, related_name='dorsal_artery_pulsation_for_boolfield_zuo_jiao_T3003', on_delete=models.CASCADE, null=True, blank=True, verbose_name='左脚')
    boolfield_you_jiao = models.ForeignKey(Dorsal_artery_pulsation, related_name='dorsal_artery_pulsation_for_boolfield_you_jiao_T3003', on_delete=models.CASCADE, null=True, blank=True, verbose_name='右脚')
    class Meta:
        verbose_name = '足背动脉检查'
        verbose_name_plural = verbose_name
...
class T3002(HsscFormModel):
    boolfield_yan_di = models.ForeignKey(Normality, related_name='normality_for_boolfield_yan_di_T3002', on_delete=models.CASCADE, null=True, blank=True, verbose_name='眼底')
    class Meta:
        verbose_name = '眼底检查'
        verbose_name_plural = verbose_name
...
class Z6233(HsscFormModel):
    boolfield_yong_hu_ming = models.CharField(max_length=255, null=True, blank=True, verbose_name='用户名')
    boolfield_mi_ma = models.CharField(max_length=255, null=True, blank=True, verbose_name='密码')
    class Meta:
        verbose_name = '医生'
        verbose_name_plural = verbose_name
...
class A5001(HsscFormModel):
    ...
    boolfield_yao_pin_ming = models.ManyToManyField(Medicine, related_name='medicine_for_boolfield_yao_pin_ming_A5001', blank=True, verbose_name='药品名')
    class Meta:
        verbose_name = '药物处方'
        verbose_name_plural = verbose_name
...
class T4504(HsscFormModel):
    boolfield_jian_kang_jiao_yu = models.ManyToManyField(Icpc8_other_health_interventions, related_name='icpc8_other_health_interventions_for_boolfield_jian_kang_jiao_yu_T4504', blank=True, verbose_name='健康教育')
    class Meta:
        verbose_name = '健康教育'
        verbose_name_plural = verbose_name
...
class Shu_ye_zhu_she_dan(HsscFormModel):
    ...
    boolfield_yao_pin_ming = models.ManyToManyField(Medicine, related_name='medicine_for_boolfield_yao_pin_ming_shu_ye_zhu_she_dan', blank=True, verbose_name='药品名')
    class Meta:
        verbose_name = '输液注射单'
        verbose_name_plural = verbose_name
...
class A6219(HsscFormModel):
    boolfield_bing_qing_bu_chong_miao_shu = models.CharField(max_length=255, null=True, blank=True, verbose_name='病情补充描述')
    boolfield_zheng_zhuang = models.ManyToManyField(Icpc3_symptoms_and_problems, related_name='icpc3_symptoms_and_problems_for_boolfield_zheng_zhuang_A6219', blank=True, verbose_name='症状')
...
class A6203(HsscFormModel):
    ...
    boolfield_zhi_ye_zhuang_kuang = models.ForeignKey(Occupational_status, related_name='occupational_status_for_boolfield_zhi_ye_zhuang_kuang_A6203', on_delete=models.CASCADE, null=True, blank=True, verbose_name='职业状况')
    boolfield_yi_liao_fei_yong_fu_dan = models.ManyToManyField(Medical_expenses_burden, related_name='medical_expenses_burden_for_boolfield_yi_liao_fei_yong_fu_dan_A6203', blank=True, verbose_name='医疗费用负担')
    boolfield_ju_zhu_lei_xing = models.ForeignKey(Type_of_residence, related_name='type_of_residence_for_boolfield_ju_zhu_lei_xing_A6203', on_delete=models.CASCADE, null=True, blank=True, verbose_name='居住类型')
    boolfield_xue_xing = models.ForeignKey(Blood_type, related_name='blood_type_for_boolfield_xue_xing_A6203', on_delete=models.CASCADE, null=True, blank=True, verbose_name='血型')
    boolfield_qian_yue_jia_ting_yi_sheng = models.ForeignKey(Staff, related_name='staff_for_boolfield_qian_yue_jia_ting_yi_sheng_A6203', on_delete=models.CASCADE, null=True, blank=True, verbose_name='签约家庭医生')
    boolfield_jia_ting_cheng_yuan_guan_xi = models.ForeignKey(Family_relationship, related_name='family_relationship_for_boolfield_jia_ting_cheng_yuan_guan_xi_A6203', on_delete=models.CASCADE, null=True, blank=True, verbose_name='家庭成员关系')
    class Meta:
        verbose_name = '个人基本信息'
        verbose_name_plural = verbose_name
...
class A3001(HsscFormModel):
    ...
    boolfield_yun_dong_neng_li = models.ForeignKey(Exercise_time, related_name='exercise_time_for_boolfield_yun_dong_neng_li_A3001', on_delete=models.CASCADE, null=True, blank=True, verbose_name='运动能力')
    boolfield_zuo_er_ting_li = models.ForeignKey(Hearing, related_name='hearing_for_boolfield_zuo_er_ting_li_A3001', on_delete=models.CASCADE, null=True, blank=True, verbose_name='左耳听力')
    boolfield_you_er_ting_li = models.ForeignKey(Hearing, related_name='hearing_for_boolfield_you_er_ting_li_A3001', on_delete=models.CASCADE, null=True, blank=True, verbose_name='右耳听力')
    boolfield_kou_chun = models.ForeignKey(Lips, related_name='lips_for_boolfield_kou_chun_A3001', on_delete=models.CASCADE, null=True, blank=True, verbose_name='口唇')
    boolfield_chi_lie = models.ForeignKey(Dentition, related_name='dentition_for_boolfield_chi_lie_A3001', on_delete=models.CASCADE, null=True, blank=True, verbose_name='齿列')
    boolfield_yan_bu = models.ForeignKey(Pharynx, related_name='pharynx_for_boolfield_yan_bu_A3001', on_delete=models.CASCADE, null=True, blank=True, verbose_name='咽部')
    boolfield_xia_zhi_shui_zhong = models.ForeignKey(Edema, related_name='edema_for_boolfield_xia_zhi_shui_zhong_A3001', on_delete=models.CASCADE, null=True, blank=True, verbose_name='下肢水肿')
    class Meta:
        verbose_name = '体格检查表'
        verbose_name_plural = verbose_name
...
class A6211(HsscFormModel):
    ...
    boolfield_sheng_huo_shi_jian = models.ManyToManyField(Life_event, related_name='life_event_for_boolfield_sheng_huo_shi_jian_A6211', blank=True, verbose_name='生活事件')
    class Meta:
...
class A6205(HsscFormModel):
    boolfield_shou_shu_ri_qi = models.DateField(null=True, blank=True, verbose_name='手术日期')
    boolfield_shou_shu_ming_cheng = models.ForeignKey(Icpc7_treatments, related_name='icpc7_treatments_for_boolfield_shou_shu_ming_cheng_A6205', on_delete=models.CASCADE, null=True, blank=True, verbose_name='手术名称')
    class Meta:
        verbose_name = '手术史'
        verbose_name_plural = verbose_name
...
class A6214(HsscFormModel):
    boolfield_jue_de_zi_shen_jian_kang_zhuang_kuang_ru_he = models.ForeignKey(State_degree, related_name='state_degree_for_boolfield_jue_de_zi_shen_jian_kang_zhuang_kuang_ru_he_A6214', on_delete=models.CASCADE, null=True, blank=True, verbose_name='觉得自身健康状况如何')
    boolfield_jiao_zhi_guo_qu_yi_nian_zhuang_tai_ru_he = models.ForeignKey(Comparative_expression, related_name='comparative_expression_for_boolfield_jiao_zhi_guo_qu_yi_nian_zhuang_tai_ru_he_A6214', on_delete=models.CASCADE, null=True, blank=True, verbose_name='较之过去一年状态如何')
    boolfield_yun_dong_pian_hao = models.ForeignKey(Sports_preference, related_name='sports_preference_for_boolfield_yun_dong_pian_hao_A6214', on_delete=models.CASCADE, null=True, blank=True, verbose_name='运动偏好')
    boolfield_yun_dong_shi_chang = models.ForeignKey(Exercise_time, related_name='exercise_time_for_boolfield_yun_dong_shi_chang_A6214', on_delete=models.CASCADE, null=True, blank=True, verbose_name='运动时长')
    boolfield_jin_lai_you_wu_shen_ti_bu_shi_zheng_zhuang = models.ManyToManyField(Icpc3_symptoms_and_problems, related_name='icpc3_symptoms_and_problems_for_boolfield_jin_lai_you_wu_shen_ti_bu_shi_zheng_zhuang_A6214', blank=True, verbose_name='近来有无身体不适症状')
    class Meta:
...
class A6212(HsscFormModel):
    ...
    boolfield_yin_jiu_pin_ci = models.ForeignKey(Frequency, related_name='frequency_for_boolfield_yin_jiu_pin_ci_A6212', on_delete=models.CASCADE, null=True, blank=True, verbose_name='饮酒频次')
    boolfield_xi_yan_pin_ci = models.ForeignKey(Frequency, related_name='frequency_for_boolfield_xi_yan_pin_ci_A6212', on_delete=models.CASCADE, null=True, blank=True, verbose_name='吸烟频次')
    class Meta:
...
class A5002(HsscFormModel):
    boolfield_ji_bing_ming_cheng = models.ForeignKey(Icpc5_evaluation_and_diagnoses, related_name='icpc5_evaluation_and_diagnoses_for_boolfield_ji_bing_ming_cheng_A5002', on_delete=models.CASCADE, null=True, blank=True, verbose_name='疾病名称')
    ...
    boolfield_yao_pin_ming = models.ManyToManyField(Medicine, related_name='medicine_for_boolfield_yao_pin_ming_A5002', blank=True, verbose_name='药品名')
    class Meta:
        verbose_name = '药事服务'
        verbose_name_plural = verbose_name
...
class Physical_examination_athletic_ability(HsscFormModel):
    boolfield_yun_dong_neng_li = models.ForeignKey(Exercise_time, related_name='exercise_time_for_boolfield_yun_dong_neng_li_physical_examination_athletic_ability', on_delete=models.CASCADE, null=True, blank=True, verbose_name='运动能力')
    class Meta:
        verbose_name = '运动能力调查'
        verbose_name_plural = verbose_name
...
class A6213(HsscFormModel):
    boolfield_xing_ge_qing_xiang = models.ForeignKey(Character, related_name='character_for_boolfield_xing_ge_qing_xiang_A6213', on_delete=models.CASCADE, null=True, blank=True, verbose_name='性格倾向')
...
class A6210(HsscFormModel):
    boolfield_yi_chuan_xing_ji_bing = models.ForeignKey(Icpc5_evaluation_and_diagnoses, related_name='icpc5_evaluation_and_diagnoses_for_boolfield_yi_chuan_xing_ji_bing_A6210', on_delete=models.CASCADE, null=True, blank=True, verbose_name='遗传性疾病')
