    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('relatedfield_drug_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='drug_list_for_relatedfield_drug_name_yong_yao_chu_fang', to='dictionaries.drug_list', verbose_name='药品名称')),
            ],
            options={
                'verbose_name': '用药处方',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('numberfield_tang_hua_xue_hong_dan_bai_up_limit', models.DecimalField(blank=True, decimal_places=2, default=6.5, max_digits=10, null=True, verbose_name='糖化血红蛋白上限')),
                ('numberfield_tang_hua_xue_hong_dan_bai_down_limit', models.DecimalField(blank=True, decimal_places=2, default=3.9, max_digits=10, null=True, verbose_name='糖化血红蛋白下限')),
                ('customer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.customer', verbose_name='客户')),
                ('operator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.staff', verbose_name='作业人员')),
                ('pid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.operation_proc', verbose_name='作业进程id')),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('operator', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.staff', verbose_name='作业人员')),
                ('pid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='core.operation_proc', verbose_name='作业进程id')),
                ('relatedfield_disease_name', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='icpc5_evaluation_and_diagnoses_for_relatedfield_disease_name_men_zhen_zhen_duan', to='icpc.icpc5_evaluation_and_diagnoses', verbose_name='疾病名称')),
            ],
            options={
                'verbose_name': '门诊诊断',
