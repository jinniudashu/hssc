...
class Social_environment_assessment_baseform_ModelForm(ModelForm):
    class Meta:
        ...
        fields = ['relatedfield_is_the_living_environment_satisfactory', 'relatedfield_is_the_transportation_convenient', 'boolfield_whether_the_living_environment_is_clean_and_hygienic', 'boolfield_whether_there_is_noise_pollution', 'boolfield_whether_there_is_air_pollution', 'boolfield_whether_there_is_other_pollution', 'boolfield_yin_shui_shi_fou_jian_kang', ]
...
class Ce_shi_biao_dan_baseform_ModelForm(ModelForm):
    class Meta:
        model = Ce_shi_biao_dan
        fields = ['characterfield_supplementary_description_of_the_condition', 'relatedfield_personality_tendency', 'boolfield_is_life_fun', 'boolfield_do_you_often_work_overtime', 'characterfield_working_hours_per_day', 'relatedfield_are_you_satisfied_with_the_job_and_life', ]
        widgets = {'relatedfield_personality_tendency': RadioSelect, 'relatedfield_are_you_satisfied_with_the_job_and_life': Select, }
...
class Ce_shi_biao_dan_baseform_query_1639618027_ModelForm(ModelForm):
    class Meta:
        model = Ce_shi_biao_dan
        fields = ['characterfield_supplementary_description_of_the_condition', 'relatedfield_personality_tendency', ]
        widgets = {'relatedfield_personality_tendency': RadioSelect, }
...
class Basic_personal_information_baseform_query_1639620882_ModelForm(ModelForm):
    class Meta:
        model = Basic_personal_information
        fields = ['characterfield_name', 'characterfield_gender', 'characterfield_age', ]
...
class Basic_personal_information_baseform_query_1639643054_ModelForm(ModelForm):
    class Meta:
        model = Basic_personal_information
        fields = ['relatedfield_family_relationship', 'characterfield_name', 'characterfield_gender', 'characterfield_age', 'characterfield_identification_number', 'datetimefield_date_of_birth', 'relatedfield_family_id', 'characterfield_resident_file_number', 'relatedfield_gender', 'relatedfield_nationality', 'relatedfield_marital_status', 'relatedfield_education', 'relatedfield_occupational_status', 'characterfield_family_address', 'characterfield_contact_number', 'characterfield_medical_ic_card_number', 'relatedfield_medical_expenses_burden', 'relatedfield_type_of_residence', 'relatedfield_blood_type', 'boolfield_contract_signatory', 'relatedfield_signed_family_doctor', ]
        widgets = {'relatedfield_family_relationship': Select, 'relatedfield_family_id': Select, 'relatedfield_gender': Select, 'relatedfield_nationality': Select, 'relatedfield_marital_status': Select, 'relatedfield_education': Select, 'relatedfield_occupational_status': Select, 'relatedfield_medical_expenses_burden': CheckboxSelectMultiple, 'relatedfield_type_of_residence': Select, 'relatedfield_blood_type': Select, 'relatedfield_signed_family_doctor': Select, }
