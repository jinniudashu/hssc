    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pid', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='hsscbaseformmodel_pid', to='core.operationproc', verbose_name='作业进程id')),
            ],
            options={
                'abstract': False,
            },
