    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form_field1', models.CharField(blank=True, max_length=255, null=True, verbose_name='对应业务字段1')),
                ('parameter2', models.CharField(blank=True, max_length=255, null=True, verbose_name='系统参数2')),
                ('form_field2', models.CharField(blank=True, max_length=255, null=True, verbose_name='对应业务字段2')),
                ('parameter3', models.CharField(blank=True, max_length=255, null=True, verbose_name='系统参数3')),
                ('form_field3', models.CharField(blank=True, max_length=255, null=True, verbose_name='对应业务字段3')),
            ],
            options={
                'verbose_name': '系统自动作业参数',
                'verbose_name_plural': '系统自动作业参数',
                'ordering': ['id'],
            },
        ),
        migrations.CreateModel(
