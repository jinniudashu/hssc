    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('system_operand_parameter', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.systemoperandparameter', verbose_name='系统作业参数')),
            ],
            options={
                'verbose_name': '服务规则',
