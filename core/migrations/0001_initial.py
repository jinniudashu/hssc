    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.PositiveSmallIntegerField(choices=[(0, '创建'), (1, '就绪'), (2, '运行'), (3, '挂起'), (4, '结束'), (5, '撤销'), (10, '等待超时')], verbose_name='作业状态')),
                ('priority', models.PositiveSmallIntegerField(choices=[(0, '0级'), (1, '紧急'), (2, '优先'), (3, '一般')], default=3, verbose_name='优先级')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hssc_id', models.CharField(blank=True, max_length=50, null=True, unique=True, verbose_name='hsscID')),
                ('pym', models.CharField(blank=True, max_length=255, null=True, verbose_name='拼音码')),
                ('end_service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='end_service', to='core.service', verbose_name='结束作业')),
                ('include_services', models.ManyToManyField(blank=True, related_name='include_services', to='core.Service', verbose_name='包含作业')),
                ('role', models.ManyToManyField(blank=True, to='core.Role', verbose_name='服务岗位')),
                ('start_service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='start_service', to='core.service', verbose_name='起始作业')),
            ],
            options={
                'verbose_name': '服务任务',
