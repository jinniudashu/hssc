...
# Service基本信息表单Model
# **********************************************************************************************************************
class Fu_zhen_bing_li_ji_lu_fu_wu(HsscFormModel):
    boolfield_zheng_zhuang = models.ManyToManyField(Icpc3_symptoms_and_problems, related_name='icpc3_symptoms_and_problems_for_boolfield_zheng_zhuang_fu_zhen_bing_li_ji_lu_fu_wu', blank=True, verbose_name='症状')
    boolfield_jian_cha_xiang_mu = models.ManyToManyField(Icpc4_physical_examination_and_tests, related_name='icpc4_physical_examination_and_tests_for_boolfield_jian_cha_xiang_mu_fu_zhen_bing_li_ji_lu_fu_wu', blank=True, verbose_name='检查项目')
    boolfield_zhen_duan = models.ForeignKey(Icpc5_evaluation_and_diagnoses, related_name='icpc5_evaluation_and_diagnoses_for_boolfield_zhen_duan_fu_zhen_bing_li_ji_lu_fu_wu', on_delete=models.CASCADE, null=True, blank=False, verbose_name='诊断')
    boolfield_zhi_liao_xiang_mu = models.ManyToManyField(Icpc7_treatments, related_name='icpc7_treatments_for_boolfield_zhi_liao_xiang_mu_fu_zhen_bing_li_ji_lu_fu_wu', blank=False, verbose_name='治疗项目')
    boolfield_qi_ta_jian_kang_gan_yu_fu_wu = models.ManyToManyField(Icpc8_other_health_interventions, related_name='icpc8_other_health_interventions_for_boolfield_qi_ta_jian_kang_gan_yu_fu_wu_fu_zhen_bing_li_ji_lu_fu_wu', blank=True, verbose_name='其他健康干预服务')
...
class An_pai_zhi_liao_ji_hua(HsscFormModel):
...
class Shou_ci_dao_dian_que_ren(HsscFormModel):
    boolfield_dao_da_que_ren = models.ForeignKey(Qian_dao_que_ren, related_name='qian_dao_que_ren_for_boolfield_dao_da_que_ren_shou_ci_dao_dian_que_ren', on_delete=models.CASCADE, null=True, blank=False, verbose_name='到达确认')
    ...
    boolfield_jiu_zhen_ji_gou_ze_ren_ren = models.ForeignKey(Jiu_zhen_ji_gou_fu_ze_ren, related_name='jiu_zhen_ji_gou_fu_ze_ren_for_boolfield_jiu_zhen_ji_gou_ze_ren_ren_shou_ci_dao_dian_que_ren', on_delete=models.CASCADE, null=True, blank=True, verbose_name='就诊机构责任人')
    boolfield_shi_yong_fu_wu_chan_pin = models.ManyToManyField(Bao_xian_chan_pin, related_name='bao_xian_chan_pin_for_boolfield_shi_yong_fu_wu_chan_pin_shou_ci_dao_dian_que_ren', blank=True, verbose_name='使用服务产品')
...
class Tui_bao_que_ren_fu_wu(HsscFormModel):
    boolfield_ke_hu_tui_bao_shen_qing_shi_fou_tong_guo = models.ForeignKey(Qian_shu_que_ren, related_name='qian_shu_que_ren_for_boolfield_ke_hu_tui_bao_shen_qing_shi_fou_tong_guo_tui_bao_que_ren_fu_wu', on_delete=models.CASCADE, null=True, blank=False, verbose_name='客户退保申请是否通过')
...
class Tui_bao_shen_qing_fu_wu(HsscFormModel):
    ...
    boolfield_shi_yong_fu_wu_chan_pin = models.ManyToManyField(Bao_xian_chan_pin, related_name='bao_xian_chan_pin_for_boolfield_shi_yong_fu_wu_chan_pin_tui_bao_shen_qing_fu_wu', blank=False, verbose_name='使用服务产品')
...
class Chong_xin_yu_yue_an_pai(HsscFormModel):
    boolfield_yu_yue_shi_jian = models.DateTimeField(null=True, blank=False, verbose_name='预约时间')
    boolfield_jiu_zhen_wen_ti = models.CharField(max_length=255, null=True, blank=False, verbose_name='就诊问题')
    boolfield_jiu_zhen_ji_gou_ze_ren_ren = models.ForeignKey(Jiu_zhen_ji_gou_fu_ze_ren, related_name='jiu_zhen_ji_gou_fu_ze_ren_for_boolfield_jiu_zhen_ji_gou_ze_ren_ren_chong_xin_yu_yue_an_pai', on_delete=models.CASCADE, null=True, blank=True, verbose_name='就诊机构责任人')
...
class Zhen_suo_yu_yue(HsscFormModel):
    boolfield_yu_yue_shi_jian = models.DateTimeField(null=True, blank=False, verbose_name='预约时间')
    boolfield_jiu_zhen_wen_ti = models.CharField(max_length=255, null=True, blank=False, verbose_name='就诊问题')
    boolfield_jiu_zhen_ji_gou_ze_ren_ren = models.ForeignKey(Jiu_zhen_ji_gou_fu_ze_ren, related_name='jiu_zhen_ji_gou_fu_ze_ren_for_boolfield_jiu_zhen_ji_gou_ze_ren_ren_zhen_suo_yu_yue', on_delete=models.CASCADE, null=True, blank=True, verbose_name='就诊机构责任人')
...
class Yu_yue_zi_xun(HsscFormModel):
    boolfield_yu_yue_shi_jian = models.DateTimeField(null=True, blank=False, verbose_name='预约时间')
    boolfield_jiu_zhen_wen_ti = models.CharField(max_length=255, null=True, blank=False, verbose_name='就诊问题')
    boolfield_jiu_zhen_ji_gou_ze_ren_ren = models.ForeignKey(Jiu_zhen_ji_gou_fu_ze_ren, related_name='jiu_zhen_ji_gou_fu_ze_ren_for_boolfield_jiu_zhen_ji_gou_ze_ren_ren_yu_yue_zi_xun', on_delete=models.CASCADE, null=True, blank=True, verbose_name='就诊机构责任人')
...
class Fen_zhen_que_ren(HsscFormModel):
    ...
    boolfield_yu_yue_shi_jian = models.DateTimeField(null=True, blank=False, verbose_name='预约时间')
    boolfield_jiu_zhen_wen_ti = models.CharField(max_length=255, null=True, blank=False, verbose_name='就诊问题')
    boolfield_jiu_zhen_ji_gou_ze_ren_ren = models.ForeignKey(Jiu_zhen_ji_gou_fu_ze_ren, related_name='jiu_zhen_ji_gou_fu_ze_ren_for_boolfield_jiu_zhen_ji_gou_ze_ren_ren_fen_zhen_que_ren', on_delete=models.CASCADE, null=True, blank=True, verbose_name='就诊机构责任人')
...
class Yu_yue_que_ren(HsscFormModel):
    ...
    boolfield_yu_yue_shi_jian = models.DateTimeField(null=True, blank=False, verbose_name='预约时间')
    boolfield_jiu_zhen_wen_ti = models.CharField(max_length=255, null=True, blank=False, verbose_name='就诊问题')
    boolfield_jiu_zhen_ji_gou_ze_ren_ren = models.ForeignKey(Jiu_zhen_ji_gou_fu_ze_ren, related_name='jiu_zhen_ji_gou_fu_ze_ren_for_boolfield_jiu_zhen_ji_gou_ze_ren_ren_yu_yue_que_ren', on_delete=models.CASCADE, null=True, blank=True, verbose_name='就诊机构责任人')
...
class Yu_yue_an_pai(HsscFormModel):
    boolfield_yu_yue_shi_jian = models.DateTimeField(null=True, blank=False, verbose_name='预约时间')
    boolfield_jiu_zhen_wen_ti = models.CharField(max_length=255, null=True, blank=False, verbose_name='就诊问题')
    boolfield_jiu_zhen_ji_gou_ze_ren_ren = models.ForeignKey(Jiu_zhen_ji_gou_fu_ze_ren, related_name='jiu_zhen_ji_gou_fu_ze_ren_for_boolfield_jiu_zhen_ji_gou_ze_ren_ren_yu_yue_an_pai', on_delete=models.CASCADE, null=True, blank=True, verbose_name='就诊机构责任人')
