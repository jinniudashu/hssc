...
class Shu_ye_zhu_she(HsscFormModel):
    ...
    relatedfield_drug_name = models.ManyToManyField(Yao_pin_ji_ben_xin_xi_biao, related_name='yao_pin_ji_ben_xin_xi_biao_for_relatedfield_drug_name_shu_ye_zhu_she', blank=True, verbose_name='药品名')
...
class T8901(HsscFormModel):
    ...
    relatedfield_yi_lou_zhen_duan = models.ManyToManyField(Icpc5_evaluation_and_diagnoses, related_name='icpc5_evaluation_and_diagnoses_for_relatedfield_yi_lou_zhen_duan_T8901', blank=True, verbose_name='可能诊断')
    relatedfield_pai_chu_zhen_duan = models.ManyToManyField(Icpc5_evaluation_and_diagnoses, related_name='icpc5_evaluation_and_diagnoses_for_relatedfield_pai_chu_zhen_duan_T8901', blank=True, verbose_name='排除诊断')
...
class Yao_shi_fu_wu(HsscFormModel):
    ...
    relatedfield_drug_name = models.ManyToManyField(Yao_pin_ji_ben_xin_xi_biao, related_name='yao_pin_ji_ben_xin_xi_biao_for_relatedfield_drug_name_yao_shi_fu_wu', blank=True, verbose_name='药品名')
...
class Tang_niao_bing_zhuan_yong_wen_zhen(HsscFormModel):
    ...
    characterfield_supplementary_description_of_the_condition = models.CharField(max_length=255, null=True, blank=True, verbose_name='病情补充描述')
    relatedfield_symptom_list = models.ManyToManyField(Icpc3_symptoms_and_problems, related_name='icpc3_symptoms_and_problems_for_relatedfield_symptom_list_tang_niao_bing_zhuan_yong_wen_zhen', blank=True, verbose_name='症状')
...
class Men_zhen_chu_fang_biao(HsscFormModel):
    ...
    relatedfield_drug_name = models.ManyToManyField(Yao_pin_ji_ben_xin_xi_biao, related_name='yao_pin_ji_ben_xin_xi_biao_for_relatedfield_drug_name_men_zhen_chu_fang_biao', blank=True, verbose_name='药品名')
