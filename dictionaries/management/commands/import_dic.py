...
class Command(BaseCommand):
    help = '从需求系统的字典库dictionary_data中导入字典编码，参数：--dic, all-导入所有字典，dicname-导入单个字典'
    ...
    def run_import(self, name):
        ...
        dics = res.json()['data']['dictionaryData']
        ...
        for dic in dics:
            ...
            try:
                ...
                print (dic['id'], dic['value'], dic['dictionary']['name'])
        ...
        if dic:
            ...
            if dic == 'all':
                ...
                if int(count.text) > 0:
                    ...
                    #逐一导入字典
                    for dic in dic_list:
                        self.run_import(dic['name'].strip().lower())
                else:
